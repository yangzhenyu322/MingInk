...
public class ChapterController {
    ...
    @Operation(summary = "通过小说ID和状态码查询所有(status为0-草稿、1-已发布、2-下降)章节目录信息")
    ...
    @Operation(summary = "通过小说ID分页查询章节(status为0-草稿、1-已发布、2-下降)目录信息(升序排序)")
    ...
    @Operation(summary = "通过小说ID查询章节详细内容")
     ...
     */
    @PostMapping("/new")
    @Operation(summary = "章节存为草稿/发布 status: 0-草稿 1-发布")
    ...
    @Operation(summary = "通过小说Id修改小说内容")
    ...
    @Operation(summary = "修改小说章节状态 status: 0-草稿 1-发布 2-下架")
    ...
    @Operation(summary = "通过章节ID删除小说章节")
